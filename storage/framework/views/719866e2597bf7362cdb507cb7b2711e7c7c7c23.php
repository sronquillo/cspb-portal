            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">    
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(Auth::guest()): ?>
                        <li><a href="<?php echo e(url('/')); ?>">My Portal</a></li>
                        ...
                        <?php if(Auth::user()->userLevel==31 or Auth::user()->userLevel==32 or Auth::user()->userLevel==33 or Auth::user()->userLevel==34): ?>
                        <li class="dropdown">
                            ...
                            <!--Principal, Rector-->
                            <?php if(Auth::user()->userLevel==51 or Auth::user()->userLevel==52): ?>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Announcements <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu" style="font-size: 10pt">
