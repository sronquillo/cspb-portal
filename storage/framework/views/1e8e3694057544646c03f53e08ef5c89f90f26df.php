        ...
        <div class="panel panel-default"style="border-radius: 0px; background-color: whitesmoke;" >
            <div class="panel-body">
                ...
                <div class="row col-md-11">
                    <h1 style="color: #0a7e07"><?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?> (<?php echo e(Auth::user()->IDno); ?>)</h1>
                    <h5><?php echo e(Auth::user()->address); ?></h5><hr>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <table width='40%'>
                        <tr>
                            ...
                            <td width='50%' style="border-bottom: 1px solid gray"><?php echo e(Auth::user()->updated_at->format('M d, Y (D)')); ?></td>
                        </tr>
                        <tr>
                            <td width='50%' style="border-bottom: 1px solid gray">Level</td>
                            <td width='50%' style="border-bottom: 1px solid gray"><?php echo e(Auth::user()->level); ?></td>
                        </tr>
                        <tr>
                            <td width='50%' style="border-bottom: 1px solid gray">Section</td>
                            <td width='50%' style="border-bottom: 1px solid gray"><?php echo e(Auth::user()->section); ?></td>
                        </tr>
                        <tr>
                            <td width='50%' style="border-bottom: 1px solid gray">Contact Number</td>
                            <td width='50%' style="border-bottom: 1px solid gray"><?php echo e(Auth::user()->contactno); ?></td>
                        </tr>
                        <tr>
                            <td width='50%' style="border-bottom: 1px solid gray">Account Created</td>
                            <td width='50%' style="border-bottom: 1px solid gray"><?php echo e(Auth::user()->created_at->format('M d, Y (D)')); ?></td>
                        </tr>
                        <tr>
                            <td width='50%' style="border-bottom: 1px solid gray">Position</td>
                            <td width='50%' style="border-bottom: 1px solid gray">
                                <?php if(Auth::user()->userLevel==1): ?>Student
                                <?php elseif(Auth::user()->userLevel==2): ?>Teacher
                                <?php elseif(Auth::user()->userLevel==31): ?>Academic Chairman
                                <?php elseif(Auth::user()->userLevel==32): ?>Academic Coordinator
                                <?php elseif(Auth::user()->userLevel==33): ?>Registrar
                                <?php elseif(Auth::user()->userLevel==34): ?>Finance
                                <?php elseif(Auth::user()->userLevel==4): ?>Secretary
                                <?php elseif(Auth::user()->userLevel==51): ?>Principal
                                <?php elseif(Auth::user()->userLevel==52): ?>Rector
                                <?php endif; ?>
                            </td>
                        </tr><br>
                    </table>
                    ...
                    <ul class="list-group" id="MyDivName" style="overflow:auto;height:100px">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid gray"><?php echo e($announcements->firstname); ?> <?php echo e($announcements->lastname); ?></td>
                            </tr>
                            <tr>
                                <td style="border-bottom: 1px solid gray">Subject:</td>
                                <td style="border-bottom: 1px solid gray"><b><?php echo e($announcements->subject); ?></b></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: text-top; border-bottom: 1px solid gray">Message:</td>
                                <td style="border-bottom: 1px solid gray"><p><?php echo e($announcements->message); ?><br>
	                            <?php if($announcements->image!=null): ?>
	                                <img id="myImg" src="/upload-images/<?php echo e($announcements->image); ?>" alt="<?php echo e($announcements->image); ?>" width="100%"></br> 
                                    <?php endif; ?>
                                </p></td>
                            </tr>
                            <?php endforeach; ?>
               	...
               	<div class="panel-body" onMouseOver="pauseDiv2()" onMouseOut="resumeDiv2()" class = "list-group-item" id="profile">
                    <ul class="list-group" id="MyDivName2" style="overflow:auto;height:100px">
                        <table>
                            ...
                            <tr>
                                <td style="border-bottom: 1px solid gray">From:</td>
                                <td style="border-bottom: 1px solid gray"><?php echo e($notifications->firstname); ?> <?php echo e($notifications->lastname); ?></td>
                            </tr>
                            <tr>
                                <td style="border-bottom: 1px solid gray">Subject:</td>
                                <td style="border-bottom: 1px solid gray"><b><?php echo e($notifications->subject); ?></b></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: text-top; border-bottom: 1px solid gray">Message:</td>
                                <td style="border-bottom: 1px solid gray"><p><?php echo e($notifications->message); ?>

                                    <?php if($notifications->image!=null): ?>
                                        <img id="myImg2" src="/upload-images/<?php echo e($notifications->image); ?>" alt="<?php echo e($notifications->image); ?>" width="100%"></br> 
                                    <?php endif; ?>                                
                                </p></td>
                            </tr>
                            <?php endforeach; ?>
                ...
                <div class="panel-body">
                    <table border=1 width=100% align="center"  class="Table" id="table1">
                        ...
                        <tr id="tr3">
                            ...
                            <td style="text-align: center"><?php echo e($grades->q1); ?></td>
                            <td style="text-align: center"><?php echo e($grades->q2); ?></td>
                            <td style="text-align: center"><?php echo e($grades->q3); ?></td>
                            <td style="text-align: center"><?php echo e($grades->q4); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
