                            ...
                            <div class="form-group col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-7" style="padding-bottom: 10px">
                                        ...
                                        @elseif ($update_announcements->recipient_userLevel==3) Academic Chairman, Registrar, Finance
                                ...
                                <div class="row">
                                    ...
                                    <button type="submit" class="btn-outline col-md-2" onclick="myFunction()">Approved</button>
                                </div>
                            </div>
                        </form>
